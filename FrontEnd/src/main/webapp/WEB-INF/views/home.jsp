     ...
     <div class="item active">
        ...
        <div class="container">
            <div class="carousel-caption">
              <h1>Welcome to Furniture Zone</h1>
              
              
<p>Browse for your favourite Furnitures and buy .Order Now for your Amazing New kit!</p>
                          </div>
          </div>
        </div>
  ...
  <h1>Mobiles</h1>
              ...
              <p>Enjoy with your latest phone</p>
...
<p>Enjoy the latest technology</p>
            </div>
          </div>
        </div>
      </div>
